...
from user_management.views.views import UserLoginView, VerifyEmailView
...
urlpatterns = [
    ...
    # Endpoint to activate the user
    path('api/user/login', UserLoginView.as_view(), name='user-login'),
    path('api/user/verifyEmail/', VerifyEmailView.as_view(), name='verify-email'),  # Email verification
]
