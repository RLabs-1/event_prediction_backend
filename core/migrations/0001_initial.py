# Generated by Django 5.1.5 on 2025-04-07 19:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=False, help_text='Designates whether this user is logged in. Set False when user logs out.')),
                ...
                ('credentials', models.ManyToManyField(blank=True, related_name='users', to='core.credentials')),
            ],
        ),
        migrations.CreateModel(
            name='EventSystem',
